  ...
  try {
    ...
    if (
      !(
        ...
        typeof (metadata as any).ACLAddress === "string" &&
        (metadata as any).ACLAddress.startsWith("0x")
      )
    ) {
      return undefined;
    }
    if (
      !(
        ...
        typeof (metadata as any).InputVerifierAddress === "string" &&
        (metadata as any).InputVerifierAddress.startsWith("0x")
      )
    ) {
      return undefined;
    }
    if (
      !(
        ...
        typeof (metadata as any).KMSVerifierAddress === "string" &&
        (metadata as any).KMSVerifierAddress.startsWith("0x")
      )
    ) {
      return undefined;
    }
